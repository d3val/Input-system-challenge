...
public class CarSwitcher : MonoBehaviour
{
    ...
    private void HandleVehicleReset()
    {
        ...
        if (LevelManager.instance.lastCheckpointPosition != null)
        {
            vehicleTransform.rotation = LevelManager.instance.lastCheckpointPosition.rotation;
            vehicleTransform.position = LevelManager.instance.lastCheckpointPosition.position;
        }
        else
        {
